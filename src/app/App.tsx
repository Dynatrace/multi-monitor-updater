          ...
          <Flex flexDirection="column" alignItems="center" paddingY={16}>
            <Flex maxWidth={"80vw"} gap={16} flexDirection="column">
              <TitleBar>
                ...
                <TitleBar.Subtitle>
                  With the help of this tutorial app you'll be able to quickly
                  and easily build your own app that uses synthetic
                  configurations. This is also a fully functional app that
                  allows bulk updates of synthetic monitors configurations. You
                  can adapt this approach to your purposes and apply it to other
              ...
              <List>
                <Text>
                  how to build your own app that uses Dynatrace API and core UI
                  components,
                </Text>
                <Text>
                  how to deal with bulk updates of synthetic monitors
                  configurations,
                </Text>
