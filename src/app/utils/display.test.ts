...
import { TagWithSourceInfo } from '@dynatrace-sdk/client-classic-environment-v1/types/packages/client/classic-environment-v1/src/lib/models/tag-with-source-info';
...
const tags =
  '{"tags":[{"key":"my_key","value":"my_value"},{"key":"other_key"},{"key":"new_key","value":"new_value"},"*"]}';
